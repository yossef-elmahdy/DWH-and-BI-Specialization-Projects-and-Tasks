...
GROUP BY GROUPING SETS ( (date_dim.calquarter, cust_vendor_dim.zip, cust_vendor_dim.name),
						(date_dim.calquarter, cust_vendor_dim.zip),
						(date_dim.calquarter, cust_vendor_dim.name),
						(cust_vendor_dim.zip, cust_vendor_dim.name),
						date_dim.calquarter,
						cust_vendor_dim.zip,
						cust_vendor_dim.name,
					   () )
ORDER BY GROUPING(DATE_DIM.CALQUARTER, CUST_VENDOR_DIM.ZIP, CUST_VENDOR_DIM.NAME),
	DATE_DIM.CALQUARTER, CUST_VENDOR_DIM.ZIP, CUST_VENDOR_DIM.NAME
